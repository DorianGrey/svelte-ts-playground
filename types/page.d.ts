// Forked version of the type definition below that omits defining `page` as a global variable.
// This is required to avoid a definition conflict with jest-playwright. 
